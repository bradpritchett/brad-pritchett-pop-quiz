...
function question4() {
  ...
  answers.innerHTML =
    "<button class='btn btn-primary true answer'>Containers for storing data values.</button><button class='btn btn-primary true answer'>Not consistent or having a fixed pattern; liable to change.</button><button class='btn btn-primary true answer'>Able to be changed or adapted.</button><button class='btn btn-primary answer'>A small, spiky mammal.</button>";
}
